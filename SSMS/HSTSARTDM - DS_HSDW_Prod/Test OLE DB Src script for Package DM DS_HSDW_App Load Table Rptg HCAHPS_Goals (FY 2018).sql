...
FROM [DS_HSDW_App].[Rptg].[HCAHPS_Goals] Goal
...
WHERE Goal.SVC_CDE = 'IN'
AND Goal.GOAL_YR = 2018
...
(
  ...
  , INDEX IX_HCAHPS_PX_Goal_Setting_epic_id_FY19 NONCLUSTERED(GOAL_YR, UNIT, DOMAIN)
);
